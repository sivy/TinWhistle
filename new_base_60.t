...
my @dates = (
    { date => '1970-01-01', days => '0',     daysf => '000000', sxg => '0',   sxgf => '000', ord => '1970-001' },
    { date => '1970-01-02', days => '1',     daysf => '000001', sxg => '1',   sxgf => '001', ord => '1970-002' },
    { date => '1971-06-29', days => '544',   daysf => '000544', sxg => '94',  sxgf => '094', ord => '1971-180' },
    { date => '2010-05-26', days => '14755', daysf => '014755', sxg => '45v', sxgf => '45v', ord => '2010-146' },
);
...
for my $dd (@dates) {
    ...
    my $decf_value = sxg_to_numf( $dd->{sxg}, 6 );
    is( $decf_value, $dd->{daysf}, 'sxg_to_numf returns correct value (' . $dd->{daysf} . ') for ' . $ds );
