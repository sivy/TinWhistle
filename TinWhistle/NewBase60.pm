package TinWhistle::NewBase60;

# NewBase60 is a partial port of code from cassis.js (http://cassisproject.org) by Tantek Celik (http://tantek.com)
...
sub sxg_to_numf {
    my ( $s, $f ) = @_;
    if ( !defined $f ) { $f = 1; }
    return sprintf( "%0${f}s", sxg_to_num($s) );
}
